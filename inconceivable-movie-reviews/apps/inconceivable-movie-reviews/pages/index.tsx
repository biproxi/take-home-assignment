...
export function Index() {
  ...
  return (
    <div className="flex flex-row space-x-12  h-screen place-items-center y-screen place-content-center">
      <Link className="max-w-sm rounded overflow-hidden shadow-lg content-center grow transition duration-300 hover:scale-110 m-10" id="review" href="/display">
      ...
      <Link className="max-w-sm rounded overflow-hidden shadow-lg grow transition duration-300 hover:scale-110 m-10" id="review" href="/modify">
